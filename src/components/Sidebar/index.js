...
export const Sidebar = () => {
    ...
    useEffect(() => {
        const getImage = async () => {
            ...
            // console.log(typeof isprofilePresent);
            // console.log("isprofile present", isprofilePresent);
            ...
            setUrl(
                `https://profile-backend-4.onrender.com${res.data.profile.personal.photoPreview}`
            );
            localStorage.setItem("profile", JSON.stringify(res.data.profile.personal));
        };
        getImage();
    }, [url]);
